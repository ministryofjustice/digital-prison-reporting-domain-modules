  ...
  definition = var.file_transfer_in ? jsonencode(
    {
      ...
      "States" : {
        ...
        (local.run_batch_processes.StepName) : local.run_batch_processes.StepDefinition,
        (local.proceed_to_streaming_process.StepName) : local.proceed_to_streaming_process.StepDefinition,
