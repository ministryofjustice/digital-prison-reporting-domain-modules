    ...
    "StepDefinition" : {
      ...
      "Parameters" : {
        ...
        "Arguments" : {
          ...
          "--dpr.file.transfer.parallelism" : tostring(var.file_transfer_parallelism),
    ...
    "StepDefinition" : {
      ...
      "Parameters" : {
        ...
        "Arguments" : {
          ...
          "--dpr.file.source.prefix" : var.archive_backfill_folder,
          "--dpr.config.key" : var.domain
        }
      },
  ...
  empty_archive_data = {
    ...
    "StepDefinition" : {
      ...
      "Parameters" : {
        "JobName" : var.glue_s3_data_deletion_job,
        "Arguments" : {
          "--dpr.file.deletion.buckets" : var.s3_raw_archive_bucket_id,
          "--dpr.config.key" : var.domain
        }
      },
    ...
    "StepDefinition" : {
      ...
      "Parameters" : {
        ...
        "Arguments" : {
          ...
          "--dpr.file.transfer.parallelism" : tostring(var.file_transfer_parallelism),
          "--dpr.file.source.prefix" : var.archive_backfill_folder,
          "--dpr.allowed.s3.file.regex" : "(?i).+.parquet$",
          "--dpr.datastorage.retry.maxAttempts" : tostring(var.glue_s3_max_attempts),
          "--dpr.datastorage.retry.minWaitMillis" : tostring(var.glue_s3_retry_min_wait_millis),
          "--dpr.datastorage.retry.maxWaitMillis" : tostring(var.glue_s3_retry_max_wait_millis),
          "--dpr.config.s3.bucket" : var.s3_glue_bucket_id,
